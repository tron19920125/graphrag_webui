...
azure_embedding_model_id = os.getenv(
    "AZURE_EMBEDDING_MODEL_ID", "text-embedding-3-small"
)
azure_embedding_deployment_name = os.getenv(
...
data_azure_chat_deployment_name = os.getenv(
    "DATA_AZURE_CHAT_DEPLOYMENT_NAME", "gpt-4o-mini"
)
...
search_azure_chat_deployment_name = os.getenv(
    "SEARCH_AZURE_CHAT_DEPLOYMENT_NAME", "gpt-4o-mini"
)
